    ...
    <div>
      <section className="text-center pt-8 pb-16 sm:pt-12 md:pt-16 px-6">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link
            href="/contact"
            className="w-full sm:w-auto bg-blue-950 text-white px-6 py-3 rounded-full font-semibold text-center"
          >
          ...
          <Link
            href="/services"
            className="w-full sm:w-auto border border-black px-6 py-3 rounded-full font-semibold text-center"
          >
            View Services
          </Link>
        </div>
