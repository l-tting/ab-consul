  ...
  return (
    <section className="w-full py-14 md:py-12 ">
      <div className="max-w-6xl mx-auto px-5 md:px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end mb-16 md:mb-24 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-2xl md:text-3xl font-bold tracking-tighter text-slate-900 leading-tight">
              ...
              <span className="text-slate-600 italic font-medium"> uncommon</span> results.
            </p>
          </div>
          ...
          <div className="bg-blue-950 border border-blue-800/50 rounded-2xl px-4 py-3 md:px-5 md:py-4">
            <p className="text-slate-300 text-center italic text-sm font-medium max-w-full md:max-w-[290px] leading-relaxed  md:border-blue-700/50 md:pl-5">
        ...
        {/* Steps */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 cursor-pointer">
          {steps.map((item, index) => (
            ...
            >
              ...
              <div className="space-y-3 flex-1">
                ...
                <p className="text-sm font-medium leading-relaxed text-slate-600 max-w-full md:max-w-[240px]">
                  {item.description}
                </p>
              </div>
