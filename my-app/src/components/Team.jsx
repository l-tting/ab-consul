...
export default function TeamSection() {
  ...
  const team = [
    ...
    {
      name: "Brian Letting",
      title: "Systems & Infrastructure Ops", // Refined for Brian
      impact: "Operational Efficiency", // Changed from Equity to Efficiency
      ...
      metrics: ["99.9% System Resilience", "40% OpEx Optimization"] // Harder engineering metrics
    }
  ];
    ...
    <section className="w-full py-24 flex justify-center ">
      <div className="w-[92%] max-w-6xl">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-4xl md:text-6xl font-black tracking-tighter text-slate-900 mb-8 leading-[0.9]">
            Direct access to <br/>
        ...
        {/* Dynamic Grid - Exact Structure Retained */}
